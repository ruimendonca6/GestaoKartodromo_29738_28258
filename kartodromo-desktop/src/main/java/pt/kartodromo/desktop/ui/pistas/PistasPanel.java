...
public class PistasPanel extends JPanel {
    ...
    private static final Color ATIVA_COLOR   = new Color(46, 125, 50);
    private static final Color INATIVA_COLOR = new Color(158, 158, 158);
    ...
    private final JSpinner   comprimentoSpinner  = new JSpinner(new SpinnerNumberModel(500, 1, 9999, 10));
    private final JSpinner   capacidadeSpinner   = new JSpinner(new SpinnerNumberModel(10, 1, 999, 1));
    private final JComboBox<String> imagemCombo  = new JComboBox<>(IMAGENS_DISPONIVEIS);

    private final DefaultTableModel tableModel = new DefaultTableModel(
            new Object[]{"Nome", "Comprimento (m)", "Capacidade", "Estado"}, 0) {
        @Override
        public boolean isCellEditable(int row, int column) { return false; }
    };

    private final JTable table = new JTable(tableModel);
    private final JButton toggleBtn = UiStyle.createActionButton("Ativar / Inativar", new Color(245, 124, 0));
    ...
    private JScrollPane buildCardsTab() {
        ...
        grid.add(createTrackCard("Pista Técnica",  "/images/pista1.png",
                "⭐⭐⭐⭐⭐", "650 m",  "18", "Treino / Técnica"));
        grid.add(createTrackCard("Pista Completa", "/images/pista2.png",
                "⭐⭐⭐⭐",  "1200 m", "24", "Corrida Oficial"));
        grid.add(createTrackCard("Pista Sprint",   "/images/pista3.png",
                "⭐⭐⭐",   "450 m",  "10", "Sessões rápidas"));
    ...
    private JPanel createTrackCard(String nome, String imagem,
                                    String dificuldade, String comprimento,
                                    String curvas, String tipo) {
        ...
        JButton selecionarBtn = UiStyle.createActionButton("Selecionar Pista", UiStyle.PRIMARY_RED);
        selecionarBtn.addActionListener(e ->
                JOptionPane.showMessageDialog(this, nome + " selecionada com sucesso.",
                        "Pista selecionada", JOptionPane.INFORMATION_MESSAGE));
    ...
    private JPanel buildFormCard() {
        ...
        nomeField.setPreferredSize(new Dimension(200, 28));

        // Style imagemCombo to show only filename
        imagemCombo.setRenderer(new DefaultListCellRenderer() {
            @Override
        ...
        JPanel topBtns = new JPanel(new FlowLayout(FlowLayout.LEFT, 6, 0));
        ...
        JPanel bottomBtns = new JPanel(new FlowLayout(FlowLayout.LEFT, 0, 0));
    ...
    private JPanel buildTableCard() {
        ...
        JLabel title = new JLabel("LISTA DE PISTAS");
        title.setFont(UiStyle.sectionFont());
        title.setForeground(UiStyle.PRIMARY_RED);
        ...
        table.getColumnModel().getColumn(3).setCellRenderer(new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(
                ...
                boolean ativa = "Ativa".equals(value);
                setForeground(selected ? Color.WHITE : (ativa ? ATIVA_COLOR : INATIVA_COLOR));
    ...
    private void eliminarPista() {
        ...
        int confirm = JOptionPane.showConfirmDialog(
                this,
                "Eliminar a pista \"" + nomeField.getText() + "\"?",
    ...
    private void toggleAtiva() {
        ...
        try {
            Pista updated = pistaService.toggleAtiva(pistaSelecionadaId);
            String estado = updated.isAtiva() ? "ativada" : "inativada";
    ...
    private void preencherFormulario() {
        ...
        comprimentoSpinner.setValue(tableModel.getValueAt(row, 1));
        capacidadeSpinner.setValue(tableModel.getValueAt(row, 2));

        pistaService.listarPistas().stream()
                .filter(p -> p.getNome().equals(nome))
                .findFirst()
                .ifPresent(p -> {
                    pistaSelecionadaId = p.getId();
                    String img = p.getImagemPath();
                    if (img != null) imagemCombo.setSelectedItem(img);
                });
    }
    ...
    private void loadData() {
        ...
        for (Pista p : pistaService.listarPistas()) {
